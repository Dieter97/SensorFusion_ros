...
if nargin<1
  base_dir = '/home/dieter/Documents/Kitti/2011_09_26/2011_09_26_drive_0002_sync';
end
if nargin<2
...
while img_idx ~= nimages
  fileID = fopen(sprintf('/home/dieter/Documents/Results/0002/ground/data/%06d.txt',img_idx) ,'a');
  fclose(fileID);
