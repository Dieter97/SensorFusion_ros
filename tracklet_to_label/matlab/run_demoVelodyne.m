...
base directory(ends with _sync)
...
sequence)
if nargin<1
base_dir = '/home/dieter/Downloads/KITTI/2011_09_26/2011_09_26_drive_0001';
end
if nargin<2
calib_dir = '/home/dieter/Downloads/KITTI/2011_09_26';
end
        cam = 2;
% 0-
based index
...
image plane(exclude luminance)

velo_img = project(velo(
:, 1:3), P_velo_to_img);
...
1),
velo_img(i,
2), 'o', 'LineWidth', 4, 'MarkerSize', 1, 'Color',
cols(col_idx,
:));
end
